% The Susan's Requiem master file.


%	For pandoc compiles to workaround a bug in pandoc, in this source go to "begin the document" and under "half 
% title page" comment out "\halftitlepage" then comment out the "\titleM". The pandoc 
% error is senseless and the workaround is arcane and magical. But it works. The result isn't ..too.. bad. Any 
% other compilers will likely work fine without that godawful workaround.
